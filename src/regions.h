...
struct RegionComposition {
    ...
    void transition(SystemState* system, ComputationState* state, Memory& memory) const {
        ...
        wire.transition(system, state, memory);
        ...
        jsr_rts_rti.transition(system, state, memory);
        branch.transition(system, state, memory);
        rewire.transition(system, state, memory);
        implementation_state.transition(system, state, memory);
        flags.transition(system, state, memory);
        write.transition(system, state, memory);
        stack_write.transition(system, state, memory);
        program_counter.transition(system, state, memory);
    }
};
